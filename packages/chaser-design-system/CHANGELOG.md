...
- d117578: Refactor: Extract all component types into separate `.types.ts` files
  ...
  **New exports available:**
  ...
  import {
    ...
    type ButtonProps,
    type ButtonVariant,
  } from '@jordan-mace/chaser-design-system';
  ```

### Patch Changes

- 8e55bdd: docs: update README with dark mode and sprinkles API documentation
